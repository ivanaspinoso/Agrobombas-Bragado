...
const AddProducts = () => {
  ...
  */
  ...
  const schema = Yup.object().shape({
    ...
    cost: Yup.number("Debe ser un número positivo").required("El costo es requerido"),
    percent: Yup.number("Debe ser un número positivo").required("El costo es requerido"),
    price: Yup.number("Debe ser un número positivo").required("El precio es requerido"),
    iva21: Yup.number("Debe ser un número positivo").required("El IVA21 es requerido"),
     // iva10: Yup.number().positive("Debe ser un número positivo"),
     price1: Yup.number("Debe ser un número positivo").required("El precio es requerido"),
     price2: Yup.number("Debe ser un número positivo").required("El precio con tarjeta es requerido"),
     price3: Yup.number("Debe ser un número positivo").required("El precio sin IVA es requerido"),
