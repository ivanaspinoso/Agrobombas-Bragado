  ...
  return (
    <div className="container mx-auto px-4 flex flex-col flex-grow">
      <h2 className="text-center flex flex-row justify-between text-xl font-semibold my-5">
        {t('queue.queueList')}
        <button className="ml-2 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" onClick={() => navigate("/gestion/add-message")}>
            ...
            return (
              <tr key={id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-2 flex gap-2">
                  <Link to="/edit-message" state={{ id, text, senddate, sendtime }}>
