      ...
      >
        ...
        <div className="mb-3">
          <label htmlFor="author" className="form-label">
            <input type="checkbox" checked={inmediate} onChange={() => setInmediate(!inmediate)}></input>
            Enviar inmediato
          </label>
          <div>
            {!inmediate ? <div className="form-control">Fecha <DatePicker selected={senddate} onChange={(senddate) => setSendDate(senddate)} />
            <input 
            type="time"
            id="hora"
            value={sendtime}
            step="900"
            onChange={(e) => setSendTime(e.target.value)} /></div> : ""}
          </div>
          {/*           <input
            type="number"
            className="form-control"
