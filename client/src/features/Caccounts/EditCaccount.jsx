...
import { editCaccounts } from "./CaccountsSlice";
...
const EditCaccount = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-5 flex flex-col flex-grow">
      <h2 className="text-center text-xl uppercase m-5 font-semibold">Editar Movimiento</h2>
      <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          ...
          try {
            await dispatch(editCaccounts(cashflowData));
            Swal.fire({
              title: "Genial!",
        ...
        {({ errors, touched }) => (
          <Form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <div className="mb-6">
              ...
              />
              {errors.date && touched.date && <p className="text-red-500 text-xs italic">{errors.date}</p>}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <Field
                  ...
                  className="form-input mt-1 block w-full border border-gray-300 rounded px-1"
                />
                {errors.income && touched.income && <p className="text-red-500 text-xs italic">{errors.income}</p>}
              </div>
              <div>
